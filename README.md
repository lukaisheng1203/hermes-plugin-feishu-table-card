...
## 📦 安装
### 方式1：直接从GitHub安装（推荐）
> ⚠️ 请替换下面链接中的 `your-username` 为你的GitHub用户名
```bash
hermes plugins install git+https://github.com/your-username/hermes-plugin-feishu-table-card.git --enable
```
...
> ⚠️ 请替换下面链接中的 `your-username` 为你的GitHub用户名
```bash
git clone https://github.com/your-username/hermes-plugin-feishu-table-card.git
